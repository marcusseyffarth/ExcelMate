...
namespace ExcelMate
{
    public class DisplayWriterRight
    {
        mExcelMate myTimer;
        ...
        public DisplayWriterRight(mExcelMate timer, ManualResetEvent rES)
        {
            myTimer = timer;
            m_EventStopWriteToDisplayRight = rES;
        }
        ...
        private void WriteToDisplay()
        {
            ...
            while (WRITE)
            {
                try
                {
                    ...
                    if (m_EventStopWriteToDisplayRight.WaitOne(0, true))
                    {
